          ...
          <div className="w-full max-w-md space-y-8">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                >
                  <Building2 className={`w-8 h-8 mx-auto mb-2 ${
                    role === "estabelecimento" ? "text-primary" : "text-muted-foreground"
                  }`} />
                  <p className={`font-medium text-sm ${
                    role === "estabelecimento" ? "text-foreground" : "text-muted-foreground"
                  }`}>
                    Restaurante
                  </p>
                </button>
                ...
                >
                  <User className={`w-8 h-8 mx-auto mb-2 ${
                    role === "profissional" ? "text-primary" : "text-muted-foreground"
                  }`} />
                  <p className={`font-medium text-sm ${
                    role === "profissional" ? "text-foreground" : "text-muted-foreground"
                  }`}>
                    Profissional
                  </p>
                </button>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              {mode === "signup" && (
                <div className="space-y-2">
                  <Label htmlFor="nome">
                    {role === "estabelecimento" ? "Nome do Estabelecimento" : "Nome Completo"}
                  </Label>
                  <Input
                    id="nome"
                    type="text"
                    placeholder={role === "estabelecimento" ? "Nome do restaurante" : "Seu nome completo"}
                    value={formData.nome}
